...
const generateHTMLDefaultReport = require('./validatorHTMLFile') // Import the main function from the second file
...
;(async () => {
  ...
  try {
    ...
    const htmlFilePath = path.join(__dirname, 'formatted_default_report.html')
